...
class PlayTab(QTabWidget):
    ...
    def __init__(self):
        super().__init__()
        self.arrowPath = get_image_file(ARROW_FILE_NAME)
        self.ballPath = get_image_file(PINGPONG_FILE_NAME)
    ...
    def init_labels_layout(self):
        ...
        self.arrow_labels = []
        self.arrow_labels.append(self.get_picture_label(self.arrowPath, self.ARROW_SCALES[0], (Qt.AlignLeft | Qt.AlignVCenter))) 
        self.centralGridLayout.addWidget(self.arrow_labels[0], 0, 4, 1, 1)

        self.arrow_labels.append(self.get_picture_label(self.arrowPath, self.ARROW_SCALES[1], (Qt.AlignRight | Qt.AlignVCenter))) 
        self.centralGridLayout.addWidget(self.mirror_player_arrow(self.arrow_labels[1]), 0, 2, 1, 1)

        self.ball_label = self.get_picture_label(self.ballPath, self.BALL_SCALE, Qt.AlignCenter)
